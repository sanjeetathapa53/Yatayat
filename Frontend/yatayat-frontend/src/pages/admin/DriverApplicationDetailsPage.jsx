...
export default function DriverApplicationDetailsPage() {
  ...
  if (loading) {
    return (
      ...
      >
        <div className="flex min-h-105 items-center justify-center rounded-3xl border border-slate-200 bg-white">
      ...
      >
        <div className="rounded-3xl border border-red-200 bg-red-50 p-8 text-center">
          ...
          <button
            ...
            className="mt-5 inline-flex items-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-black text-white hover:bg-red-700"
          >
            <RefreshCw size={17} />
            Try Again
          </button>
    ...
    >
      <div className="space-y-6">
        <button
          ...
          className="inline-flex items-center gap-2 text-sm font-black text-[#08264a] hover:underline"
        >
          <ArrowLeft size={17} />
              ...
              {application.verificationStatus === "PENDING" && (
                <div className="mt-6 space-y-3">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3 text-sm font-black text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {actionLoading ? (
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="flex w-full items-center justify-center gap-2 rounded-xl border border-red-300 bg-red-50 py-3 text-sm font-black text-red-700 transition hover:bg-red-100 disabled:opacity-60"
                  >
                    <XCircle size={18} />
                    Reject Application
                  </button>
          ...
          <div className="w-full max-w-md rounded-3xl bg-white shadow-2xl">
            ...
            <div className="flex gap-3 border-t border-slate-200 bg-slate-50 p-5">
              <button
                ...
                disabled={actionLoading}
                className="flex-1 rounded-xl border border-slate-300 bg-white py-3 text-sm font-black text-slate-700 hover:bg-slate-100 disabled:opacity-60"
              >
                Keep Pending
              </button>
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-red-600 py-3 text-sm font-black text-white hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {actionLoading ? (
...
function DetailCard({ label, value, icon }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
      ...
      <p className="mt-2 flex items-start gap-2 wrap-break-word text-sm font-black text-slate-900">
        {icon && (
